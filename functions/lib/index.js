...
exports.newsletterActualizacion = exports.newsletter = exports.confirmacion = exports.processVolunteerAttendanceCredits = exports.mergeCertificatesPdf = exports.generateCertificates = void 0;
...
var legacyRestore_js_1 = require("./legacyRestore.js");
Object.defineProperty(exports, "generateCertificates", { enumerable: true, get: function () { return legacyRestore_js_1.generateCertificates; } });
...
const tedxLogoPath = node_path_1.default.resolve(process.cwd(), "assets", "logo-white.png");
const tedxLogoPublicUrl = "https://raw.githubusercontent.com/Jose21NC/TEDx/main/app/media/logo-white.png";
let tedxLogoBase64Cache = null;
function getTedxLogoBase64() {
    if (!tedxLogoBase64Cache) {
        tedxLogoBase64Cache = node_fs_1.default.readFileSync(tedxLogoPath).toString("base64");
    }
...
function getTedxLogoInlineAttachment() {
    return [
        {
...
function getStatusChangeCopy(source, recipientName, applicationStatus, trackingUrl) {
...
function getConfirmationCopy(source, recipientName) {
...
async function resendEmail(recipientEmail, subject, html, text, attachments) {
...
exports.newsletter = (0, https_1.onRequest)({ cors: true, secrets: [mailchimpApiKey] }, async (request, response) => {
    ...
    try {
        const subscriberHash = node_crypto_1.default.createHash("md5").update(email).digest("hex");
        const mailchimpResponse = await fetch(`https://${mailchimpServerPrefix.value()}.api.mailchimp.com/3.0/lists/${mailchimpAudienceId.value()}/members/${subscriberHash}`, {
            method: "PUT",
            headers: {
